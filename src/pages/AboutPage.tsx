  ...
  return (
    <Page variant="narrow" className="about-page">
      ...
      <section className="about-section">
        ...
        <p>
          หมากรุกไทย (Makruk) เป็นรูปแบบเก่าแก่ที่{' '}
          <strong>วิวัฒน์จาก Chaturanga ของอินเดียคล้ายกับหมากรุกสากล</strong>{' '}
          — ทั้งสองเกมเป็น "ลูกพี่ลูกน้อง" ที่แยกสายกันมาเป็นพันปี โดย
          Makruk รักษากฎหลายข้อจากบรรพบุรุษร่วม (เช่นการเดินของขุน
          1 ช่อง, เม็ดเดินทแยง 1 ช่อง) ไว้ใกล้กับต้นฉบับมากกว่า. ปัจจุบัน
          ยังมีผู้เล่นในประเทศไทยเป็นจำนวนมาก (ประมาณ{' '}
          <a
            href="https://en.wikipedia.org/wiki/Makruk"
            target="_blank"
            rel="noopener noreferrer"
          >2 ล้านคน ตาม Wikipedia</a>) แต่เครื่องมือดิจิทัลสำหรับการฝึก
          ยังจำกัด: เว็บที่รองรับ Makruk ส่วนใหญ่เน้น PvP หรือเป็น
          variant หนึ่งใน 30+ ของ chess engine ทั่วไป (เช่น pychess.org).
          {' '}<strong>OpenMakruk</strong> สร้างเพื่อเติมเต็มช่องว่าง:
          เครื่องมือ <em>training + analysis</em> เป็นภาษาไทย ครบในที่เดียว.
        </p>
        <p>
